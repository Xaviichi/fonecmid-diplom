...
Процедура ОтпускаСотрудниковДатаНачалаПриИзменении(Элемент)
	...
	Если ЗначениеЗаполнено(Элементы.ОтпускаСотрудников.ТекущиеДанные.ДатаОкончания) 
		И ЗначениеЗаполнено(Элементы.ОтпускаСотрудников.ТекущиеДанные.ДатаНачала) Тогда
		Элементы.ОтпускаСотрудников.ТекущиеДанные.КоличествоДней = (НачалоДня(Элементы.ОтпускаСотрудников.ТекущиеДанные.ДатаОкончания) 
...
Процедура ОтпускаСотрудниковДатаОкончанияПриИзменении(Элемент)
	...
	Если ЗначениеЗаполнено(Элементы.ОтпускаСотрудников.ТекущиеДанные.ДатаНачала) 
		И ЗначениеЗаполнено(Элементы.ОтпускаСотрудников.ТекущиеДанные.ДатаОкончания) Тогда
		Элементы.ОтпускаСотрудников.ТекущиеДанные.КоличествоДней = (НачалоДня(Элементы.ОтпускаСотрудников.ТекущиеДанные.ДатаОкончания) 
			- НачалоДня(Элементы.ОтпускаСотрудников.ТекущиеДанные.ДатаНачала)) / (60 * 60 * 24);
	КонецЕсли;
